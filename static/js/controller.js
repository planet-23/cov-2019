...
function get_left2(){
    $.ajax({
        ...
        success:function (datas) {
            ...
            ec_left2_Option.series[0].data = datas['confirm_add']
            ec_left2_Option.series[1].data = datas['suspect_add']
...
get_right2()
setInterval(get_center1,1000000)
setInterval(get_center2,1000000)
setInterval(get_left1,1000000)
setInterval(get_left2,1000000)
get_center1()
get_center2()
get_left1()
get_left2()
setInterval(get_right1,1000000)
get_right1()
setInterval(get_update,432000000)
